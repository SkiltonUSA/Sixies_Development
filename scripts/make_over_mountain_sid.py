#!/usr/bin/env python3
"""Build the current demo SID asset from the Over Mountain ACME source."""
...
SOURCE = ROOT / "src/music/over_mountain_sid.a"
PRG = ROOT / "build/over_mountain_sid.prg"
...
def main() -> None:
    ...
    header[0x16:0x36] = psid_text("Over The Mountain Ascent")
