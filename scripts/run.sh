  ...
  <head>
    ...
    <style>
      ...
      .card {
        padding: 28px;
        border-radius: 20px;
        background: linear-gradient(180deg, rgba(18, 36, 58, 0.95), rgba(7, 15, 28, 0.95));
