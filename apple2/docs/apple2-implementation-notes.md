...
- The centered text-mode table reuses the 1 KB DHGR transfer buffer, adding no dedicated high-score array to BSS. The emulator launcher preserves the writable `HISCORE` file while replacing the rest of its working disk with the latest release build.
